...
The file waterbird_cleaning_annotated_workflow.rmd contains a worked example of how to call these series of functions, and provides more detail on the rationale of each process.
